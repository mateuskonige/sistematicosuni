    ...
    <div class="max-w-screen-xl mx-auto">
      <section id="footer">
        ...
        >
          <div>
            <Link href="/"
              ><img :src="logo" alt="Escudo dos Sistemáticos" class="w-28 h-28"
            /></Link>
          </div>
          <div>
            <a
        ...
        >
          ...
          <div
            class="space-x-4 mt-8 md:mt-0 flex justify-center md:justify-end"
          >
            <a
              href="https://discord.gg/XXGBQAXrRv"
              target="_blank"
              type="button"
              class="
                p-3
            ...
            ></a>
            <a
              href="https://www.instagram.com/sistematicosuni"
              target="_blank"
              type="button"
              class="
                p-2
            ...
            <a
              ...
              class="
                ...
                ease-out
              "
              href="https://www.tiktok.com/@sistematicosuni"
              target="_blank"
              ><svg
                xmlns="https://www.w3.org/2000/svg"
                x="0px"
