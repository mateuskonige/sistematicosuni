    ...
    <div class="max-w-5xl mx-auto">
      <section id="footer">
        ...
        >
          ...
          <div
            class="space-x-4 mt-4 md:mt-0 flex justify-center md:justify-end"
          >
            <a type="button" class="p-3 rounded-full bg-blue-800" href=""
              ><svg
              ...
              >
                ...
                ></path></svg
            ></a>
            <a type="button" class="p-2 rounded-full bg-blue-800" href=""
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
