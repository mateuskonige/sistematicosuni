    ...
    <div class="bg-blue-900">
        <div class="max-w-screen-xl mx-auto">
          ...
          ">
                    ...
                    <div class="space-x-4 mt-4 md:mt-0 flex justify-center md:justify-end">
              ...
              "><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 64 64"
                ...
                transition-all
                ease-out
              " href="https://www.tiktok.com/@sistematicosuni" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
