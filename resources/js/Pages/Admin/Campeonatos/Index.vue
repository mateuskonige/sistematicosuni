        ...
        <table class="w-full text-sm text-left text-gray-500">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              ...
              <th scope="col" class="py-3 px-6 float-right">Ações</th>

            </tr>
          </thead>
          <tbody>
            <tr class="bg-white border-b" v-for="(campeonato, index) in campeonatos" :key="index">
              ...
              <td class="py-4 px-6 inline-flex space-x-4 float-right">
                <Link class="
                    ...
                    text-[10px]
                    tracking-widest
                  " :href="route('admin.campeonatos.edit', campeonato.id)">Editar</Link>
